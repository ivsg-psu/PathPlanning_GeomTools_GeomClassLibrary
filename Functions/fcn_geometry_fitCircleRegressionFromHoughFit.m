function [regression_fit_circle_center_and_radius, domain_box] = fcn_geometry_fitCircleRegressionFromHoughFit(source_points, associated_points_in_domain, varargin)
...
std_dev_transverse_distance = std(radial_distances);
