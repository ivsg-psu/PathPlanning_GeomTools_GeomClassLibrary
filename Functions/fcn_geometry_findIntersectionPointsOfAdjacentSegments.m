function intersectionPoints = fcn_geometry_findIntersectionPointsOfAdjacentSegments(curveStartPoint, sortedHoughSegmentEndPoints, curveEndPoint, varargin)
% fcn_geometry_findIntersectionPointsOfSegments
%
