% script_test_fcn_geometry_GridsWithZerosNonzeros
% Exercises the function: fcn_geometry_GridsWithZerosNonzeros
% Revision history:
...
[gridIndices_cell_array,total_N_points_in_each_grid,gridCenters, grids_with_zero_points, grids_greater_than_zero_points, gridCenters_zero_point_density, gridCenters_greater_than_zero_point_density] = fcn_geometry_GridsWithZerosNonzeros(input_points,grid_size,grid_boundaries,fig_num_LLA);