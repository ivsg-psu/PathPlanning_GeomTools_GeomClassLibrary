...
if flag_do_plots
    ...
    if 0==flag_is_feasible
        ...
        if flag_arc_is_arc
            fcn_geometry_plotGeometry('arc', closest_feasible_arc_parameters,segment_length, format_string, (figNum));
        else
            fcn_geometry_plotGeometry('circle', closest_feasible_arc_parameters,segment_length, format_string, (figNum));
        end
    end
