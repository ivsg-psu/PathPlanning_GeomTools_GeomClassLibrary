...
%
% NOTE: C1 continuity of arcs is opposite the continuity requirement for C2
% continuity. Thus, all arcs alignments NOT C2 continuous should be C1
% continuous, and vice versa.
%
% Format:
%  [flag_is_feasible, feasibility_distance, closest_feasible_arc2_parameters] = fcn_geometry_isC1FeasibleArcToArc(...
...
if flag_do_plots
    ...
    % Add a title
    if 0==flag_is_feasible
        sgtitle(sprintf('NOT C1 feasible, dist: %.2f',feasibility_distance));
    else
        sgtitle(sprintf('C1 feasible, dist: %.2f',feasibility_distance));
    end
