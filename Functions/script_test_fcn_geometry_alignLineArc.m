...
true_line_params   = round([true_segment_unit_tangent_vector true_start_point_xy 0 segment_s_end-segment_s_start],4);
...
for ith_test = 1:NtotalTests
    ...
    [revised_line_parameters, revised_arc_parameters] = ...
        fcn_geometry_alignLineArc(arc_parameters, segment_parameters, (tolerance), (continuity_level), (fig_num));
