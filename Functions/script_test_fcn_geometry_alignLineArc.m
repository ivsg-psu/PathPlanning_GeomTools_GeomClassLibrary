...
[revised_line_parameters, revised_arc_parameters] = fcn_geometry_alignLineArc(...
    line_parameters, arc_parameters, (tolerance), (continuity_level), (figNum));
...
for ith_test = 1:16 % NtotalTests
    ...
    [revised_line_parameters, revised_arc_parameters] = ...
        fcn_geometry_alignLineArc(line_parameters, arc_parameters, (tolerance), (continuity_level), (figNum));
...
if 1==0
    ...
    points = [2 3];
    [slope,intercept] = fcn_geometry_alignLineArc(points,figNum);
