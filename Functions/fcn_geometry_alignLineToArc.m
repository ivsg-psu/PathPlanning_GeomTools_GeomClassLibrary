function [revised_arc_parameters, revised_segment_parameters, revised_intermediate_geometry_join_type, revised_intermediate_geometry_join_parameters] = fcn_geometry_alignLineToArc( arc_parameters, segment_parameters, varargin)
...
% the two objects at the join location. If the offset is less than a
% threshold (default is 0.1 meter), the second geometric object is shifted
% to force alignment.
%
% Format:
...
% fcn_geometry_alignLineToArc(arc_parameters, segment_parameters, (threshold), (continuity_level),  (fig_num))
%
% INPUTS:
%
