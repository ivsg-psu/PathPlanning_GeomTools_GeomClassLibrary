function [drivable_grids, non_drivable_grids, unmapped_grids, gridCenters_mapped_grids, drivable_grid_numbers_in_mapped_grids, non_drivable_grid_numbers_in_mapped_grids] = fcn_geometry_surfaceAnalysis(input_points, grid_size, grid_boundaries, point_density, theta_threshold, std_threshold, varargin)
...
for ith_mapped_grid = 1:total_mapped_grids
    % [parameters, standard_deviation_in_z, z_fit, unit_normal_vectors(ith_mapped_grid,:), base_point, standard_deviation_in_plane_orthogonals(ith_mapped_grid,:)] = fcn_geometry_fitPlaneLinearRegression(input_points(original_mapped_grids{ith_mapped_grid},:),-1);
