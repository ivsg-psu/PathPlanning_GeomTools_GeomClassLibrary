...
fig_num = fig_nuM;
[endPointsCell, sortedHoughSegmentEndPoints] = fcn_geometry_sortHoughSegments(regression_domains, fig_num);
...
% verifyIntersectionBool = fcn_geometry_verifyIntersectionPoint(endPointsCell, intersectionPoints);
