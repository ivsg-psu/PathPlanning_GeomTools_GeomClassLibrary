%% script_test_fcn_geometry_isArcToArcFeasible
% Tests the function fcn_geometry_isArcToArcFeasible
...
%% 1.2.1 Basic test - circle2 in circle1
...
% Set continuity_level, threshold and in_boundary_margin
continuity_level = 2;
threshold = 0;
in_boundary_margin = [];

% Call function
[flag_is_feasible, feasibility_distance, closest_feasible_arc2_parameters] = fcn_geometry_isArcToArcFeasible(circle1_parameters, circle2_parameters, continuity_level, (threshold), (in_boundary_margin), (figNum));
...
spiral_join_parameters = fcn_geometry_spiralFromCircleToCircle(circle1_parameters, closest_feasible_arc2_parameters, flag_circle2_is_counterclockwise, spiral_figNum);
...
%% 1.2.2 Basic test - circle1 in circle2
...
%% 1.2.3 Basic test - circle1 outside of circle2
...
% Call function
[flag_is_feasible, feasibility_distance, closest_feasible_arc2_parameters] = fcn_geometry_isArcToArcFeasible(arc1_parameters, arc2_parameters, continuity_level, (threshold), (in_boundary_margin), (figNum));
...
spiral_join_parameters = fcn_geometry_spiralFromCircleToCircle(arc1_parameters, closest_feasible_arc2_parameters, flag_arc2_is_counterclockwise, spiral_figNum);
