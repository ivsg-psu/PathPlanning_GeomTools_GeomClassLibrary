...
segment_length = [];
format_string  = [];
XY_data = fcn_geometry_printGeometry('none', [],segment_length, format_string, (fig_num));
...
XY_data = fcn_geometry_printGeometry('circle', circle_parameters,segment_length, format_string, (fig_num));
...
XY_data = fcn_geometry_printGeometry('arc', arc_parameters,segment_length, format_string, (fig_num));
...
segment_length = [];
format_string  = [];
XY_data = fcn_geometry_printGeometry('line', line_parameters,segment_length, format_string, (fig_num));
axis equal
...
segment_length = [];
format_string  = [];
XY_data = fcn_geometry_printGeometry('segment', segment_parameters,segment_length, format_string, (fig_num));
axis equal
...
segment_length = [];
format_string  = [];
XY_data = fcn_geometry_printGeometry('spiral', spiral_parameters,segment_length, format_string, (fig_num));
axis equal
...
if 1==0
    ...
    points = [2 3];
    [slope,intercept] = fcn_geometry_printGeometry(points,fig_num);
