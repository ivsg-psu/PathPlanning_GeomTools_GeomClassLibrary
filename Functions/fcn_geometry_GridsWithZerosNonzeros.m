function [gridIndices_cell_array,total_N_points_in_each_grid,gridCenters, grids_with_zero_points, grids_greater_than_zero_points, gridCenters_zero_point_density, gridCenters_greater_than_zero_point_density] = fcn_geometry_GridsWithZerosNonzeros(input_points,grid_size,grid_boundaries,varargin)
%% fcn_geometry_GridsWithZerosNonzeros
% divide a set of input points into a grid and analyze the distribution of points within these grids 
% 
%
% FORMAT:
%
%      [gridIndices_cell_array,total_N_points_in_each_grid,gridCenters, grids_with_zero_points, grids_greater_than_zero_points ] = fcn_geometry_GridsWithZerosNonzeros(input_points,grid_size,grid_boundaries,varargin)
%
% INPUTS:     
%       
...
%
%       See the script:
%       script_test_fcn_geometry_GridsWithZerosNonzeros.m for a full
%       test suite.
%
% Revision History
