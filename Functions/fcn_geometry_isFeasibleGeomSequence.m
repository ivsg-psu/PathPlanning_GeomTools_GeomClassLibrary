function [revised_fitSequence_types, revised_fitSequence_parameters] = ...
    fcn_geometry_isFeasibleGeomSequence(input_types, input_parameters, continuity, varargin)
%% fcn_geometry_isFeasibleGeomSequence
...
% fcn_geometry_isFeasibleGeomSequence(fitSequence_bestFitType, fitSequence_parameters, threshold, (figNum))
%
% INPUTS:
...
% EXAMPLES:
%
% See the script: script_test_fcn_geometry_isFeasibleGeomSequence
...
for ith_fit = 1:NfitsInSequence-1
    ...
    if flag_do_debug
        ...
        sgtitle('Debugging')
        subplot(1,2,2);
        fcn_geometry_plotFitSequences(revised_sequence_types, revised_sequence_parameters,(debug_figNum_iterated));
        temp_axis = axis;
